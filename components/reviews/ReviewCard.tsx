  ...
  return (
    <>
      <motion.article
        ...
        className="rounded-2xl border border-white/[0.04] bg-card/80 p-4 space-y-3"
      >
        {/* Header */}
            ...
            <div className="relative">
              ...
              {showMenu && (
                <motion.div
                  ...
                  className="absolute right-0 top-full z-20 mt-1 w-36 rounded-xl backdrop-blur-xl bg-[hsl(225_14%_7%_/_0.95)] border border-white/[0.06] shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)] py-1 overflow-hidden"
                >
                  {isOwner && (
                    <>
                      <button
                        onClick={() => { setShowMenu(false); setEditOpen(true) }}
                        className="flex w-full items-center gap-2 px-3 py-2 text-sm hover:bg-white/[0.05] transition-colors touch-manipulation"
                      >
                      ...
                      <button
                        ...
                        disabled={deleting}
                        className="flex w-full items-center gap-2 px-3 py-2 text-sm text-destructive hover:bg-destructive/10 transition-colors touch-manipulation disabled:opacity-50"
                      >
                  ...
                  {!isOwner && currentUserId && (
                    <button
                      ...
                      className="flex w-full items-center gap-2 px-3 py-2 text-sm text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors touch-manipulation"
                    >
        ...
        {showMovie && review.movie && (
          <Link href={`/film/${review.movie.tmdbId}`}>
            <div className="flex items-center gap-2 rounded-lg bg-white/[0.03] hover:bg-white/[0.05] transition-colors p-2">
              <MovieCard
