  ...
  theme: {
    extend: {
      colors: {
        ...
        // Watch Dat brand colors — emerald-teal accent
        cinema: {
          50:  '#ecfdf5',
          100: '#d1fae5',
          200: '#a7f3d0',
      ...
      boxShadow: {
        'glow-green': '0 0 20px -5px rgba(16, 185, 129, 0.2), 0 0 40px -10px rgba(16, 185, 129, 0.1)',
        'glow-green-sm': '0 0 15px -3px rgba(16, 185, 129, 0.15)',
        'glow-green-xs': '0 0 8px -2px rgba(16, 185, 129, 0.12)',
